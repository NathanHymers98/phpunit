...
class DinosaurFactory
{
    ...
    public function createDinosaur(string $genus, bool $isCarnivorours, int $length): Dinosaur // This method will be responsible for creating new Dinosaur objects and in order to create a dinosaur it needs to have 3 arguments.
    {
    ...
    {
        // default values
        $codeName = 'InG-' . random_int(1, 99999); // $codeName will be used as genus
